...
## What can do:
- **Text Translation**: Receive input text, translate it using **googletrans** third-party app which use **google-translate** third-party API, and return the translated text to the user.
